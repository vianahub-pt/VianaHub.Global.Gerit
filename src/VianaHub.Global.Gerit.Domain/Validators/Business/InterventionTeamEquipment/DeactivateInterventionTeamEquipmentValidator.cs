...
public class DeactivateInterventionTeamEquipmentValidator : AbstractValidator<InterventionTeamEquipmentEntity>
{
    public DeactivateInterventionTeamEquipmentValidator(ILocalizationService localization)
    {
