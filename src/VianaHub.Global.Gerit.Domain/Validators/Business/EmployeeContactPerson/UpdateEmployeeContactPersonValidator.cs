...
/// </summary>
public class UpdateEmployeeContactPersonValidator : AbstractValidator<EmployeeContactPersonsEntity>
{
    private readonly ILocalizationService _localization;

    public UpdateEmployeeContactPersonValidator(ILocalizationService localization)
    {
        ...
        RuleFor(x => x.IsDeleted)
            .Equal(false)
            .WithMessage(_localization.GetMessage("Domain.EmployeeContactPerson.CannotUpdateDeleted"));
    }
}
