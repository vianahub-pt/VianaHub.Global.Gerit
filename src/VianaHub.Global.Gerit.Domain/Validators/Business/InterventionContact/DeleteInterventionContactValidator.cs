...
/// <summary>
/// Validador para deleção de InterventionContact
/// </summary>
public class DeleteInterventionContactValidator : AbstractValidator<InterventionContactEntity>
{
    public DeleteInterventionContactValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
