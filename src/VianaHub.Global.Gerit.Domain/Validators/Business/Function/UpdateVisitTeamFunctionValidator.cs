...
public class UpdateVisitTeamFunctionValidator : AbstractValidator<VisitTeamFunctionsEntity>
{
    public UpdateVisitTeamFunctionValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
