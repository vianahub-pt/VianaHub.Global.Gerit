...
public class DeactivateVisitTeamFunctionValidator : AbstractValidator<VisitTeamFunctionsEntity>
{
    public DeactivateVisitTeamFunctionValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
