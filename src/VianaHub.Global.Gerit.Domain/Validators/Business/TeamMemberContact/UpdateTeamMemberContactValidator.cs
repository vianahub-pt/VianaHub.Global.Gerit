...
/// <summary>
/// Validator para atualização de TeamMemberContact
/// </summary>
public class UpdateTeamMemberContactValidator : AbstractValidator<TeamMemberContactEntity>
{
    private readonly ILocalizationService _localization;

    public UpdateTeamMemberContactValidator(ILocalizationService localization)
    {
        ...
        RuleFor(x => x.IsDeleted)
            .Equal(false)
            .WithMessage(_localization.GetMessage("Domain.TeamMemberContact.CannotUpdateDeleted"));
    }
}
