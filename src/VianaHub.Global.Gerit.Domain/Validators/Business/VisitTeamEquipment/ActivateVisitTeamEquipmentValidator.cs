...
public class ActivateVisitTeamEquipmentValidator : AbstractValidator<VisitTeamEquipmentEntity>
{
    public ActivateVisitTeamEquipmentValidator(ILocalizationService localization)
    {
