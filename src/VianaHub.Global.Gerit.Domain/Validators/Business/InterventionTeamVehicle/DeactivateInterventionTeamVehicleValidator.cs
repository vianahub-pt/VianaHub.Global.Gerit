...
public class DeactivateInterventionTeamVehicleValidator : AbstractValidator<InterventionTeamVehicleEntity>
{
    public DeactivateInterventionTeamVehicleValidator(ILocalizationService localization)
    {
