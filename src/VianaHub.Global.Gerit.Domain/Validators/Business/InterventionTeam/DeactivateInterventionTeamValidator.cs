...
public class DeactivateInterventionTeamValidator : AbstractValidator<InterventionTeamEntity>
{
    public DeactivateInterventionTeamValidator(ILocalizationService localization)
    {
