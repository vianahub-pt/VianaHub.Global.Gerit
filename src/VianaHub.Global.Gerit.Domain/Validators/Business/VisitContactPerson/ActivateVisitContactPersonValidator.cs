...
/// </summary>
public class ActivateVisitContactPersonValidator : AbstractValidator<VisitContactPersonsEntity>
{
    public ActivateVisitContactPersonValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
