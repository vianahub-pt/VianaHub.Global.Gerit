...
/// </summary>
public class UpdateVisitContactPersonValidator : AbstractValidator<VisitContactPersonsEntity>
{
    public UpdateVisitContactPersonValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
