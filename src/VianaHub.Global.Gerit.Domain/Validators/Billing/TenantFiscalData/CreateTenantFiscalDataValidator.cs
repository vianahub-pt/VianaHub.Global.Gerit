...
/// <summary>
/// Validador para criação de TenantFiscalData
/// </summary>
public class CreateTenantFiscalDataValidator : AbstractValidator<TenantFiscalDataEntity>
{
    public CreateTenantFiscalDataValidator(ILocalizationService localization)
    {
        ...
        RuleFor(x => x.CreatedBy)
            .GreaterThan(0)
            .WithMessage(localization.GetMessage("Domain.TenantFiscalData.CreatedByRequired"));
    }
}
