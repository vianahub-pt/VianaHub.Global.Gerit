...
/// </summary>
public class UpdateTenantContactPersonValidator : AbstractValidator<TenantContactPersonsEntity>
{
    public UpdateTenantContactPersonValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
        ...
        RuleFor(x => x.IsDeleted)
            .Equal(false)
            .WithMessage(localization.GetMessage("Domain.TenantContactPerson.CannotUpdateDeleted"));
    }
}
