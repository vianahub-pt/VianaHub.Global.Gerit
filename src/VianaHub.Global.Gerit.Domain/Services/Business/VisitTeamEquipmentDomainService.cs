...
public class VisitTeamEquipmentDomainService : IVisitTeamEquipmentDomainService
{
    private readonly IVisitTeamEquipmentDataRepository _repo;
    private readonly IEntityDomainValidator<VisitTeamEquipmentEntity> _validator;
    private readonly INotify _notify;

    public VisitTeamEquipmentDomainService(IVisitTeamEquipmentDataRepository repo, IEntityDomainValidator<VisitTeamEquipmentEntity> validator, INotify notify)
    {
        _repo = repo;
    ...
    public async Task<bool> CreateAsync(VisitTeamEquipmentEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> ActivateAsync(VisitTeamEquipmentEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeactivateAsync(VisitTeamEquipmentEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeleteAsync(VisitTeamEquipmentEntity entity, CancellationToken ct)
    {
