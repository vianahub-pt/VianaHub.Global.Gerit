...
public class FileTypeDomainService : IFileTypeDomainService
{
    private readonly IFileTypeDataRepository _repo;
    private readonly IEntityDomainValidator<FileTypeEntity> _validator;
    private readonly INotify _notify;

    public FileTypeDomainService(
        IFileTypeDataRepository repo,
        IEntityDomainValidator<FileTypeEntity> validator,
        INotify notify)
    {
        _repo = repo;
    ...
    public async Task<bool> CreateAsync(FileTypeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> ActivateAsync(FileTypeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeactivateAsync(FileTypeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeleteAsync(FileTypeEntity entity, CancellationToken ct)
    {
