...
public class InterventionDomainService : IInterventionDomainService
{
    private readonly IInterventionDataRepository _repo;
    private readonly IEntityDomainValidator<InterventionEntity> _validator;
    private readonly INotify _notify;

    public InterventionDomainService(
        IInterventionDataRepository repo,
        IEntityDomainValidator<InterventionEntity> validator,
        INotify notify)
    {
        _repo = repo;
    ...
    public async Task<bool> CreateAsync(InterventionEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> ActivateAsync(InterventionEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeactivateAsync(InterventionEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeleteAsync(InterventionEntity entity, CancellationToken ct)
    {
