...
public class TeamMemberDomainService : ITeamMemberDomainService
{
    ...
    private readonly IEntityDomainValidator<TeamMemberEntity> _validator;
    private readonly INotify _notify;

    public TeamMemberDomainService(
        ITeamMemberDataRepository repo,
        IEntityDomainValidator<TeamMemberEntity> validator,
        INotify notify)
    {
        _repo = repo;
    ...
    public async Task<bool> CreateAsync(TeamMemberEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> ActivateAsync(TeamMemberEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeactivateAsync(TeamMemberEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeleteAsync(TeamMemberEntity entity, CancellationToken ct)
    {
