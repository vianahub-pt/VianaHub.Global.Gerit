...
/// </summary>
public class ClientContactPersonDomainService : IClientContactPersonDomainService
{
    ...
    public ClientContactPersonDomainService(
        IClientContactPersonDataRepository repo,
