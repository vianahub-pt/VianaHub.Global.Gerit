...
public class OriginTypeDomainService : IOriginTypeDomainService
{
    private readonly IOriginTypeDataRepository _repo;
    private readonly IEntityDomainValidator<OriginTypeEntity> _validator;
    private readonly INotify _notify;

    public OriginTypeDomainService(
        IOriginTypeDataRepository repo,
        IEntityDomainValidator<OriginTypeEntity> validator,
        INotify notify)
    {
        _repo = repo;
    ...
    public async Task<bool> CreateAsync(OriginTypeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> ActivateAsync(OriginTypeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeactivateAsync(OriginTypeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeleteAsync(OriginTypeEntity entity, CancellationToken ct)
    {
