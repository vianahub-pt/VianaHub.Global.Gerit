...
public class VisitDomainService : IVisitDomainService
{
    private readonly IVisitDataRepository _repo;
    private readonly IEntityDomainValidator<VisitEntity> _validator;
    private readonly INotify _notify;

    public VisitDomainService(
        IVisitDataRepository repo,
        IEntityDomainValidator<VisitEntity> validator,
        INotify notify)
    {
        _repo = repo;
    ...
    public async Task<bool> CreateAsync(VisitEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> ActivateAsync(VisitEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeactivateAsync(VisitEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeleteAsync(VisitEntity entity, CancellationToken ct)
    {
