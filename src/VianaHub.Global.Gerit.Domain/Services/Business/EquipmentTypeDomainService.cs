...
public class EquipmentTypeDomainService : IEquipmentTypeDomainService
{
    private readonly IEquipmentTypeDataRepository _repo;
    private readonly IEntityDomainValidator<EquipmentTypeEntity> _validator;
    private readonly INotify _notify;

    public EquipmentTypeDomainService(
        IEquipmentTypeDataRepository repo,
        IEntityDomainValidator<EquipmentTypeEntity> validator,
        INotify notify)
    {
        _repo = repo;
    ...
    public async Task<bool> CreateAsync(EquipmentTypeEntity entity, CancellationToken ct)
    {
