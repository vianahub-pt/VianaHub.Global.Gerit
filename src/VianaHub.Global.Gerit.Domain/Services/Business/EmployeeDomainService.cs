...
public class EmployeeDomainService : IEmployeeDomainService
{
    ...
    private readonly IEntityDomainValidator<EmployeeEntity> _validator;
    private readonly INotify _notify;

    public EmployeeDomainService(
        IEmployeeDataRepository repo,
        IEntityDomainValidator<EmployeeEntity> validator,
        INotify notify)
    {
        _repo = repo;
    ...
    public async Task<bool> CreateAsync(EmployeeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> ActivateAsync(EmployeeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeactivateAsync(EmployeeEntity entity, CancellationToken ct)
    {
    ...
    public async Task<bool> DeleteAsync(EmployeeEntity entity, CancellationToken ct)
    {
