...
/// </summary>
public class SubscriptionPlanFileRulesEntity : Entity
{
    ...
    protected SubscriptionPlanFileRulesEntity() { }

    /// <summary>
    /// Construtor para criação de uma nova regra de arquivo para SubscriptionPlan
    /// </summary>
    public SubscriptionPlanFileRulesEntity(int subscriptionPlanId, int fileTypeId, int maxFileSizeMB, int createdBy)
    {
