...
/// </summary>
public class TenantDocumentEntity : Entity
{
    ...
    protected TenantDocumentEntity() { }

    /// <summary>
    /// Construtor para criação de um novo Documento do Tenant
    /// </summary>
    public TenantDocumentEntity(int tenantId, int documentTypeId, string documentNumber,
