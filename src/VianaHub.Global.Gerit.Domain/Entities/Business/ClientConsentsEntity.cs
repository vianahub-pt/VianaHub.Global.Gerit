...
namespace VianaHub.Global.Gerit.Domain.Entities.Business
{
    public class ClientConsentsEntity : Entity
    {
        ...
        public int ConsentOriginTypeId { get; private set; }
        ...
        public ConsentOriginTypeEntity ConsentOriginType { get; private set; } = null!;

        // Construtor protegido para EF Core
        protected ClientConsentsEntity() { }

        public ClientConsentsEntity(int tenantId, int clientId, int consentTypeId, int consentOriginTypeId, bool granted, DateTime grantedDate, string? ipAddress, string? userAgent, int createdBy)
        {
            TenantId = tenantId;
            ClientId = clientId;
            ConsentTypeId = consentTypeId;
            ConsentOriginTypeId = consentOriginTypeId;
            Granted = granted;
        ...
        public void Update(int consentOriginTypeId, string? ipAddress, string? userAgent, int modifiedBy)
        {
            ConsentOriginTypeId = consentOriginTypeId;
            IpAddress = ipAddress;
            UserAgent = userAgent;
