...
/// <summary>
/// Entidade que representa dados fiscais de um Cliente Empresa
/// </summary>
public class ClientCompanyFiscalDataEntity : Entity
{
    ...
    public ClientCompanyEntity ClientCompany { get; private set; }

    protected ClientCompanyFiscalDataEntity() { }

    public ClientCompanyFiscalDataEntity(int tenantId, int clientCompanyId, string taxNumber,
