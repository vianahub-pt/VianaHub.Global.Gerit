...
/// </summary>
public class StatusDefinitionTranslationEntity
{
    ...
    protected StatusDefinitionTranslationEntity() { }

    /// <summary>
    /// Construtor para criação de uma nova tradução de StatusDefinition
    /// </summary>
    public StatusDefinitionTranslationEntity(int tenantId, int statusDomainId, int statusDefinitionId, string languageCode, string name, string? description)
    {
        TenantId = tenantId;
