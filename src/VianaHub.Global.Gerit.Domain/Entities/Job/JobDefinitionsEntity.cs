...
public class JobDefinitionsEntity : Entity, IAggregateRoot
{
    ...
    protected JobDefinitionsEntity() { }

    // F�brica de cria��o com valores padr�o conforme regras de neg�cio
    public JobDefinitionsEntity(
        string jobCategory,
        string jobName,
        string jobType,
        int createdBy,
