...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddGeritInfrastructure(this IServiceCollection services)
    {
        ...
        services.AddScoped<IEntityDomainValidator<EmployeeContactPersonsEntity>, EmployeeContactValidator>();
        ...
        services.AddScoped<IEntityDomainValidator<VisitContactPersonsEntity>, VisitContactValidator>();
        ...
        services.AddScoped<IClientContactDataRepository, ClientContactRepository>();
