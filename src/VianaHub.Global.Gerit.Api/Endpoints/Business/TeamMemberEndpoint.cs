...
public static class TeamMemberEndpoint
{
    public static void MapTeamMemberEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        groupV1.MapGet("/{id}", async ([FromRoute] int id, [FromServices] ITeamMemberAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPut("/{id}", async ([FromRoute] int id, [FromBody] UpdateTeamMemberRequest request, [FromServices] ITeamMemberAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/activate", async ([FromRoute] int id, [FromServices] ITeamMemberAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/deactivate", async ([FromRoute] int id, [FromServices] ITeamMemberAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapDelete("/{id}", async ([FromRoute] int id, [FromServices] ITeamMemberAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
