...
public static class InterventionTeamEquipmentsEndpoint
{
    public static void MapInterventionTeamEquipmentsEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        groupV1.MapGet("/{id}", async (int id, [FromServices] IInterventionTeamEquipmentsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPut("/{id}", async (int id, [FromBody] UpdateInterventionTeamEquipmentRequest request, [FromServices] IInterventionTeamEquipmentsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/activate", async (int id, [FromServices] IInterventionTeamEquipmentsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/deactivate", async (int id, [FromServices] IInterventionTeamEquipmentsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapDelete("/{id}", async (int id, [FromServices] IInterventionTeamEquipmentsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
