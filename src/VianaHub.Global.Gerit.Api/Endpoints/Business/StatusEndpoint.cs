...
public static class StatusEndpoint
{
    public static void MapStatusEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        groupV1.MapGet("/{id}", async (int id, [FromServices] IStatusAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPut("/{id}", async (int id, [FromBody] UpdateStatusRequest request, [FromServices] IStatusAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/activate", async (int id, [FromServices] IStatusAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/deactivate", async (int id, [FromServices] IStatusAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapDelete("/{id}", async (int id, [FromServices] IStatusAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
