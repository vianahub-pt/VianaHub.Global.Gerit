...
public static class InterventionTeamVehiclesEndpoint
{
    public static void MapInterventionTeamVehiclesEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        groupV1.MapGet("/{id}", async (int id, [FromServices] IInterventionTeamVehiclesAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPut("/{id}", async (int id, [FromBody] UpdateInterventionTeamVehicleRequest request, [FromServices] IInterventionTeamVehiclesAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/activate", async (int id, [FromServices] IInterventionTeamVehiclesAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/deactivate", async (int id, [FromServices] IInterventionTeamVehiclesAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapDelete("/{id}", async (int id, [FromServices] IInterventionTeamVehiclesAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
