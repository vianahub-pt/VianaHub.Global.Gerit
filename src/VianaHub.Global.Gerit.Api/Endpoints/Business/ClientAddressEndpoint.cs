...
public static class ClientAddressEndpoint
{
    public static void MapClientAddressEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        groupV1.MapGet("/{id}", async (int id, [FromServices] IClientAddressAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPut("/{id}", async (int id, [FromBody] UpdateClientAddressRequest request, [FromServices] IClientAddressAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/activate", async (int id, [FromServices] IClientAddressAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/deactivate", async (int id, [FromServices] IClientAddressAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapDelete("/{id}", async (int id, [FromServices] IClientAddressAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
