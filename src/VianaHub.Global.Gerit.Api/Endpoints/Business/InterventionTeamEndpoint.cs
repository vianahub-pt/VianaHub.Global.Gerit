...
public static class InterventionTeamEndpoint
{
    public static void MapInterventionTeamsEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        groupV1.MapGet("/{id}", async ([FromRoute] int id, [FromServices] IInterventionTeamsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPut("/{id}", async ([FromRoute] int id, [FromBody] UpdateInterventionTeamRequest request, [FromServices] IInterventionTeamsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/activate", async ([FromRoute] int id, [FromServices] IInterventionTeamsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapPatch("/{id}/deactivate", async ([FromRoute] int id, [FromServices] IInterventionTeamsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
        ...
        groupV1.MapDelete("/{id}", async ([FromRoute] int id, [FromServices] IInterventionTeamsAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
