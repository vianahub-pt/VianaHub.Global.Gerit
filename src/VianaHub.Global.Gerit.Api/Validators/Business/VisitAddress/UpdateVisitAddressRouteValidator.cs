...
/// <summary>
/// Validador de rota para atualização de VisitAddress
/// </summary>
public class UpdateVisitAddressRouteValidator : AbstractValidator<UpdateVisitAddressRequest>
{
    public UpdateVisitAddressRouteValidator(ILocalizationService localization)
    {
