...
namespace VianaHub.Global.Gerit.Api.Validators.Business.ClientIndividual;

public class UpdateClientIndividualRouteValidator : AbstractValidator<UpdateClientIndividualRequest>
{
    public UpdateClientIndividualRouteValidator()
    {
