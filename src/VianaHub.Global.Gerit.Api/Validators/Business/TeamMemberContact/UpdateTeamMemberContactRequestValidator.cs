...
public class UpdateTeamMemberContactRequestValidator : AbstractValidator<UpdateTeamMemberContactRequest>
{
    public UpdateTeamMemberContactRequestValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Name)
