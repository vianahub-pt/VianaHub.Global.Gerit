...
public class CreateEquipmentTypeRouteValidator : AbstractValidator<CreateEquipmentTypeRequest>
{
    public CreateEquipmentTypeRouteValidator(ILocalizationService localization)
    {
        RuleFor(x => x.Name)
            .NotEmpty()
