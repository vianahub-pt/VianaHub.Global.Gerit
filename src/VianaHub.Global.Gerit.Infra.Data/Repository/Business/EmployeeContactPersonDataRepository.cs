...
public class EmployeeContactPersonDataRepository : IEmployeeContactPersonDataRepository
{
    private readonly GeritDbContext _context;

    public EmployeeContactPersonDataRepository(GeritDbContext context)
    {
        _context = context;
    }
