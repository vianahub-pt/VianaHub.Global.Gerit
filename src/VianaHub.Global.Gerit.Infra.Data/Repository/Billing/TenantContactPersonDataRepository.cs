...
/// </summary>
public class TenantContactPersonDataRepository : ITenantContactPersonDataRepository
{
    private readonly GeritDbContext _context;

    public TenantContactPersonDataRepository(GeritDbContext context)
    {
        _context = context;
    }
    ...
    {
        return await _context.TenantContactPersons
            .AsNoTracking()
            .AsSplitQuery()
            .Include(x => x.Tenant)
    ...
    {
        var query = _context.TenantContactPersons
            .AsNoTracking()
            .AsSplitQuery()
            .Include(x => x.Tenant)
            .Where(x => !x.IsDeleted);
