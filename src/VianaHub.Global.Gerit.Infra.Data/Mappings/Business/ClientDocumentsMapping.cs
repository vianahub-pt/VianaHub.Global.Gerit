...
/// </summary>
public class ClientDocumentsMapping : IEntityTypeConfiguration<ClientDocumentsEntity>
{
    public void Configure(EntityTypeBuilder<ClientDocumentsEntity> builder)
    {
