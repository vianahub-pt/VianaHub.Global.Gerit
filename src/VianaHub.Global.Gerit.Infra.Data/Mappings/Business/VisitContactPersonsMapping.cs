...
/// Contatos da interven��o com suporte a Row Level Security
/// </summary>
public class VisitContactPersonsMapping : IEntityTypeConfiguration<VisitContactPersonsEntity>
{
    public void Configure(EntityTypeBuilder<VisitContactPersonsEntity> builder)
    {
