...
public class VisitAttachmentsMapping : IEntityTypeConfiguration<VisitAttachmentsEntity>
{
    public void Configure(EntityTypeBuilder<VisitAttachmentsEntity> builder)
    {
