...
/// Endere�os da interven��o com suporte a Row Level Security
/// </summary>
public class VisitAddressesMapping : IEntityTypeConfiguration<VisitAddressesEntity>
{
    public void Configure(EntityTypeBuilder<VisitAddressesEntity> builder)
    {
        ...
        // Corrigido: coluna correta � VisitId
