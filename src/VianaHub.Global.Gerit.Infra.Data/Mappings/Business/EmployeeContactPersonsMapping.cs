...
/// </summary>
public class EmployeeContactPersonsMapping : IEntityTypeConfiguration<EmployeeContactPersonsEntity>
{
    public void Configure(EntityTypeBuilder<EmployeeContactPersonsEntity> builder)
    {
