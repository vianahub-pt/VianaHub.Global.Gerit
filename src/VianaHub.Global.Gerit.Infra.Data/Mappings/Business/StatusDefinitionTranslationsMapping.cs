...
/// </summary>
public class StatusDefinitionTranslationsMapping : IEntityTypeConfiguration<StatusDefinitionTranslationsEntity>
{
    public void Configure(EntityTypeBuilder<StatusDefinitionTranslationsEntity> builder)
    {
