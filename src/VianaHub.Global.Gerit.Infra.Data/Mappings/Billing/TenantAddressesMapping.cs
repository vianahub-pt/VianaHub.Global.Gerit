...
/// </summary>
public class TenantAddressesMapping : IEntityTypeConfiguration<TenantAddressesEntity>
{
    public void Configure(EntityTypeBuilder<TenantAddressesEntity> builder)
    {
