...
/// </summary>
public class SubscriptionPlanFileRulesMapping : IEntityTypeConfiguration<SubscriptionPlanFileRulesEntity>
{
    public void Configure(EntityTypeBuilder<SubscriptionPlanFileRulesEntity> builder)
    {
