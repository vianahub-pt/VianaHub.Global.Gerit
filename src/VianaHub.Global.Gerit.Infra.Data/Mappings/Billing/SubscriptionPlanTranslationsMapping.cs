...
/// </summary>
public class SubscriptionPlanTranslationsMapping : IEntityTypeConfiguration<SubscriptionPlanTranslationsEntity>
{
    public void Configure(EntityTypeBuilder<SubscriptionPlanTranslationsEntity> builder)
    {
